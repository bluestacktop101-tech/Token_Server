...
const jobs: JobPosition[] = [
  ...
  },
  {
    ...
    location: "Fully Remote / Global",
    type: "Full-Time / Part-Time",
    notionUrl: "https://www.notion.so/Full-Stack-Engineer-34203938ce4280f19963ed94574c8ef5",
    description: "You'll work across the stack — from frontend interfaces to backend services and blockchain integrations.",
    responsibilities: [
      "Build frontend features in React / Next.js",
      "Work on backend APIs and services in Node.js",
      "Integrate smart contracts into the product (wallets, transactions, state updates)",
      "Handle blockchain interactions using ethers.js / similar tools",
      "Work with on-chain data (events, reads, writes, indexing basics)",
      "Help connect frontend, backend, and smart contracts into one system",
      "Fix issues and ship features quickly",
    ],
    requirements: [
      "Strong experience with JavaScript / TypeScript",
      "Good hands-on experience with React / Next.js",
      "Experience building backend services with Node.js",
      "Basic understanding of blockchain (wallets, transactions, smart contracts)",
      "Experience integrating Web3 libraries (ethers.js)",
      "Comfortable working in early-stage environments where things change fast",
      "Able to work independently and figure things out",
    ],
    niceToHave: [
      "Solidity experience or ability to read smart contracts",
      "Understanding of EVM ecosystems (Ethereum, Polygon, Arbitrum)",
      "Exposure to DeFi or NFT projects",
      "Experience with indexing (The Graph or event-based systems)",
      "Startup / 0→1 product experience",
      "Basic system design understanding",
    ],
    techStack: ["React / Next.js", "Node.js", "Ethereum + L2", "Solidity", "IPFS + off-chain databases"],
    whyThisRole: [
      "You’ll work on a real product, not an idea",
      "Full-stack ownership across Web2 + Web3",
      "Early-stage equity / token upside",
    ...
    howToApply: ["GitHub / portfolio", "Projects you've built (frontend, backend, or Web3)", "Short note on your experience with React + Node"],
  },
  {
